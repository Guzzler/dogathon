...
export const scheduleBlocks: ScheduleBlock[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "s-weigh-4", label: "Weight check", kind: "checkup", done: false },
    ],
  },
  {
    id: "month-2",
...
export const tips: Tip[] = [
  {
    ...
    category: "Adjustment",
    urgency: "info",
    body: "{dog} may hide, sleep a lot, or seem 'off' — that's normal. Give a quiet corner, a soft bed, and let him come to you. Rule of thumb: 3 days to decompress, 3 weeks to feel at home, 3 months to feel like family.",
  },
  {
    id: "tip-crate",
    ...
    urgency: "info",
    body: "Feed every meal inside the crate with the door open. {dog} walks in for the food, walks out on his own — no forcing. Within a week, the crate becomes 'the good place.' Once he goes in on his own, start closing the door for the duration of the meal.",
  },
  {
    id: "tip-teething",
    ...
    urgency: "info",
    body: "Puppies peak biting around 12–16 weeks. Wet a washcloth, twist it, freeze it — hand it over when {dog} gets mouthy. Cold soothes the gums and redirects the bite off your hand. Keep 2–3 in rotation.",
  },
  {
    id: "tip-honeymoon",
    ...
    category: "Behavior",
    urgency: "info",
    body: "Around week 3–4, dogs feel safe enough to test limits. This isn't regression — it's trust. Reinforce basic cues calmly, hold your routine, and don't take it personally when {dog} ignores you the first few times.",
  },
  {
    id: "tip-adoption",
    title: "Building {dog}'s adoption profile",
  ...
  {
    id: "tip-not-eating",
    title: "{dog} skipped meals — try this first",
    category: "Feeding",
    urgency: "warn",
  ...
  },
  {
    ...
    category: "Crate training",
    urgency: "info",
    body: "Never force. Leave the door open, toss a treat just inside, then further. Feed all meals in there. If {dog} whines at night, a soft blanket over the crate + something that smells like you often does it.",
  },
  {
    id: "tip-scared",
    title: "{dog} is scared of things",
    category: "Behavior",
    urgency: "info",
    body: "Fear in the first 2 weeks is normal — new sounds, new house, new humans. Don't force exposure. Let {dog} retreat, reward calm approaches with high-value treats, and go at his pace. Most fears fade with routine.",
  },
];
